package com.ssafy.stab.webrtc.websocket;
...
public class CustomWebSocket extends AsyncTask<Void, Void, Void> implements WebSocketListener {
    ...
    public interface WebSocketCallback {
        void onConnected();
        void onDisconnected();
        void onParticipantJoined(String participant);
        void onParticipantLeft(String participant);
        void onError(String message);
    }

    private WebSocketCallback callback;

    public CustomWebSocket(Session session, WebSocketCallback callback) {
    ...
    private void handleServerError(JSONObject json) throws JSONException {
        ...
        if (callback != null) {
            callback.onError("Server error: " + error.getString("message"));
        }
    }
...
//        remoteParticipant.dispose();
        String participantId = params.getString("id");
        if (callback != null) {
            callback.onParticipantLeft(participantId);
        }
    }
